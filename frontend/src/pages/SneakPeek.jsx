...
const products = [
  ...
  { id: 4, name: 'New: Ivory Silk Saree', image: product1, price: 12999, originalPrice: 18999, rating: 4.5, reviews: 128, isNew: true },
  { id: 5, name: 'Latest: Blush Pink Lehenga', image: product2, price: 15999, originalPrice: 22999, rating: 4.8, reviews: 256, isNew: true },
  { id: 6, name: 'New Style: Teal Georgette Set', image: product3, price: 9999, originalPrice: 14999, rating: 4.3, reviews: 89, isNew: true },
  { id: 7, name: 'Fresh Arrival: Gold Tissue Saree', image: product8, price: 13999, originalPrice: 19999, rating: 4.7, reviews: 234, isNew: true },
  { id: 8, name: 'Just Launched: Ruby Red Lehenga', image: product5, price: 45999, originalPrice: 65999, rating: 5.0, reviews: 456, isNew: true },
];
...
const SneakPeek = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Navbar />
      <div className="relative h-[300px] md:h-[400px] bg-gradient-to-r from-violet-200/40 to-fuchsia-200/40">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center px-4">
            <div className="flex items-center justify-center gap-3 mb-4">
              <Sparkles className="text-primary" size={32} />
              <h1 className="font-display text-4xl md:text-6xl text-foreground">Sneak Peek & What's New</h1>
              <Sparkles className="text-primary" size={32} />
            </div>
            ...
            {products.map((product, index) => (
              <Link key={product.id} to={`/product/${product.id}`} className="group product-card animate-fade-up" style={{ animationDelay: `${index * 0.05}s` }}>
                <div className="relative overflow-hidden aspect-[3/4]">
                  ...
                  {product.isNew && (
                    <div className="absolute top-3 left-3 bg-green-600 text-white px-2 py-1 text-xs font-body font-semibold rounded-sm">
                      NEW
                    </div>
                  )}
