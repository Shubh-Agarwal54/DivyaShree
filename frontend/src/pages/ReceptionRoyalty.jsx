...
const fallbackProducts = [
  ...
  { id: 4, name: 'Pearl White Sharara', image: product4, price: 24999, originalPrice: 35999, rating: 4.9, reviews: 312 },
  { id: 5, name: 'Dusty Rose Lehenga', image: product2, price: 15999, originalPrice: 22999, rating: 4.8, reviews: 256 },
  { id: 6, name: 'Silver Grey Gown', image: product8, price: 13999, originalPrice: 19999, rating: 4.7, reviews: 234 },
  { id: 7, name: 'Blush Pink Saree', image: product3, price: 9999, originalPrice: 14999, rating: 4.3, reviews: 89 },
  { id: 8, name: 'Beige Tissue Lehenga', image: product6, price: 11999, originalPrice: 16999, rating: 4.4, reviews: 167 },
];
...
const ReceptionRoyalty = () => {
  ...
  useEffect(() => { 
    ...
    const fetchProducts = async () => {
      setLoading(true);
      try {
        const params = { occasion: 'reception', limit: 50 };
        if (sortBy === 'price-low') {
          params.sortBy = 'price';
          params.order = 'asc';
  ...
  return (
    <div className="min-h-screen bg-background">
      <Navbar />
      <div className="relative h-[300px] md:h-[400px] bg-gradient-to-r from-amber-100/60 to-rose-100/60">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center px-4">
            <h1 className="font-display text-4xl md:text-6xl text-foreground mb-4">Reception Royalty</h1>
            <p className="font-body text-lg text-muted-foreground max-w-2xl mx-auto">
              Exquisite elegance for your grand reception
            </p>
          </div>
        </div>
      </div>
...
export default ReceptionRoyalty;
