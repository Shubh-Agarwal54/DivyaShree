...
const fallbackProducts = [
  { id: 1, name: 'Emerald Green Silk Saree', image: product6, price: 11999, originalPrice: 16999, rating: 4.4, reviews: 167 },
  { id: 2, name: 'Ivory Anarkali with Gold Work', image: product1, price: 12999, originalPrice: 18999, rating: 4.5, reviews: 128 },
  { id: 3, name: 'Saffron Yellow Lehenga', image: product4, price: 24999, originalPrice: 35999, rating: 4.9, reviews: 312 },
  { id: 4, name: 'Red Tissue Saree', image: product2, price: 15999, originalPrice: 22999, rating: 4.8, reviews: 256 },
  { id: 5, name: 'White Sharara Set', image: product7, price: 18999, originalPrice: 27999, rating: 4.6, reviews: 198 },
  { id: 6, name: 'Peach Silk Lehenga', image: product5, price: 45999, originalPrice: 65999, rating: 5.0, reviews: 456 },
  { id: 7, name: 'Olive Green Saree', image: product8, price: 13999, originalPrice: 19999, rating: 4.7, reviews: 234 },
  { id: 8, name: 'Cream Georgette Suit', image: product3, price: 9999, originalPrice: 14999, rating: 4.3, reviews: 89 },
];

const PujaCollection = () => {
  ...
  useEffect(() => { 
    ...
    const fetchProducts = async () => {
      setLoading(true);
      try {
        const result = await productAPI.getAllProducts({ occasion: 'puja', limit: 50 });
  ...
  return (
    <div className="min-h-screen bg-background">
      <Navbar />
      <div className="relative h-[300px] md:h-[400px] bg-gradient-to-r from-green-200/40 to-yellow-200/40">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center px-4">
            <h1 className="font-display text-4xl md:text-6xl text-foreground mb-4">Puja Collection</h1>
            <p className="font-body text-lg text-muted-foreground max-w-2xl mx-auto">
              Traditional elegance for sacred ceremonies
            </p>
          </div>
        </div>
      </div>
