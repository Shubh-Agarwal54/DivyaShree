...
const products = [
  {
    id: 1,
    name: 'Fuchsia Pink Lehenga with Mirror Work',
    image: product5,
    price: 45999,
    originalPrice: 65999,
    rating: 5.0,
...
const SangeetStyle = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="relative h-[300px] md:h-[400px] bg-gradient-to-r from-purple-600/20 to-pink-500/20">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center px-4">
            ...
            <p className="font-body text-lg text-muted-foreground max-w-2xl mx-auto">
              Dance the night away in stunning, vibrant outfits
            </p>
          </div>
        </div>
      </div>
